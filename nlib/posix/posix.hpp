...
namespace letin
{
  namespace nlib
  {
    namespace posix
    {
      ...
      bool pid_to_system_pid(std::int64_t pid, ::pid_t &system_pid);
      LETIN_NATIVE_INT_CONVERTER(topid, pid_to_system_pid, ::pid_t);

      bool wait_pid_to_system_wait_pid(std::int64_t pid, ::pid_t &system_pid);
      LETIN_NATIVE_INT_CONVERTER(towpid, wait_pid_to_system_wait_pid, ::pid_t);

      bool useconds_to_system_useconds(std::int64_t useconds, ::useconds_t &system_useconds);
      LETIN_NATIVE_INT_CONVERTER(touseconds, useconds_to_system_useconds, ::useconds_t);
      ...
      bool check_timespec(vm::VirtualMachine *vm, vm::ThreadContext *context, const vm::Object &object);
