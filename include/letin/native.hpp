...
const LETIN_NATIVE_REF_CHECKER_TYPE(fun_name) name = LETIN_NATIVE_REF_CHECKER_TYPE(fun_name)(fun_name)
...
const LETIN_NATIVE_OBJECT_CHECKER_TYPE(fun_name) name = LETIN_NATIVE_OBJECT_CHECKER_TYPE(fun_name)(fun_name)
...
const LETIN_NATIVE_UNIQUE_REF_CHECKER_TYPE(fun_name) name = LETIN_NATIVE_UNIQUE_REF_CHECKER_TYPE(fun_name)(fun_name)
...
const LETIN_NATIVE_UNIQUE_OBJECT_CHECKER_TYPE(fun_name) name = LETIN_NATIVE_UNIQUE_OBJECT_CHECKER_TYPE(fun_name)(fun_name)
...
inline LETINT_NATIVE_INT_CONVERTER_TYPE(fun_name, type) name(type &x)           \
{ return LETINT_NATIVE_INT_CONVERTER_TYPE(fun_name, type)(fun_name, x); }       \
LETINT_NATIVE_INT_CONVERTER_TYPE(fun_name, type) name(type &x)
...
inline LETINT_NATIVE_FLOAT_CONVERTER_TYPE(fun_name, type) name(type &x)         \
{ return LETINT_NATIVE_FLOAT_CONVERTER_TYPE(fun_name, type)(fun_name, x); }     \
LETINT_NATIVE_FLOAT_CONVERTER_TYPE(fun_name, type) name(type &x)
...
inline LETINT_NATIVE_REF_CONVERTER_TYPE(fun_name, type) name(type &x)           \
{ return LETINT_NATIVE_REF_CONVERTER_TYPE(fun_name, type)(fun_name, x); }       \
LETINT_NATIVE_REF_CONVERTER_TYPE(fun_name, type) name(type &x)
...
inline LETINT_NATIVE_OBJECT_CONVERTER_TYPE(fun_name, type) name(type &x)        \
{ return LETINT_NATIVE_OBJECT_CONVERTER_TYPE(fun_name, type)(fun_name, x); }    \
LETINT_NATIVE_OBJECT_CONVERTER_TYPE(fun_name, type) name(type &x)
...
inline LETINT_NATIVE_REF_SETTER_TYPE(fun_name, type) name(const type &x)        \
{ return LETINT_NATIVE_REF_SETTER_TYPE(fun_name, type)(fun_name, x); }          \
LETINT_NATIVE_REF_SETTER_TYPE(fun_name, type) name(type &x)
...
inline LETINT_NATIVE_OBJECT_SETTER_TYPE(fun_name, type) name(const type &x)     \
{ return LETINT_NATIVE_OBJECT_SETTER_TYPE(fun_name, type)(fun_name, x); }       \
LETINT_NATIVE_OBJECT_SETTER_TYPE(fun_name, type) name(type &x)
