  ...
  namespace vm
  {
    namespace test
    {
      ...
      void GarbageCollectorTests::test_gc_collects_cycle_references()
      {
        ...
        ref1->raw().rs[0] = ref4;
        ref2->raw().tes[0] = Value(ref1);
        ref2->raw().tes[1] = Value(1);
        ref3->raw().rs[0] = ref2;
        ref4->raw().tes[0] = Value(2);
        ref4->raw().tes[1] = Value(ref3);
      ...
      void GarbageCollectorTests::test_gc_does_not_collect_objects_in_thread_contexts()
      {
        ...
        ref5->raw().rs[0] = ref2;
        Reference ref6(_M_gc->new_object(OBJECT_TYPE_TUPLE, 4));
        ref6->raw().tes[0] = Value(ref3);
        ref6->raw().tes[1] = Value(2);
        ref6->raw().tes[2] = Value(ref3);
        ref6->raw().tes[3] = Value(2.0);
      ...
      void GarbageCollectorTests::test_gc_does_not_collect_objects_in_vm_contexts()
      {
        ...
        ref7->raw().tes[0] = Value(1);
        ref7->raw().tes[1] = Value(ref3);
        ref7->raw().tes[2] = Value(ref4);
      ...
      void GarbageCollectorTests::test_gc_destructor_free_all_objects()
      {
        ...
        ref4->raw().tes[0] = Value(1.0);
        ref4->raw().tes[1] = Value(ref1);
        ref4->raw().tes[2] = Value(2.0);
